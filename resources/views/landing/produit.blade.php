                ...
                <div class="col-12">
                    <div class="tabs_area">
                        ...
                        <ul class="nav nav-tabs" role="tablist" id="product-tab">
                            <li class="nav-item">
                                <a href="#top-sellers" class="nav-link" data-toggle="tab" role="tab">Plombierie
                                    </a>
                            </li>

                            <li class="nav-item">
                                <a href="#on-sale" class="nav-link active" data-toggle="tab" role="tab"> Maçonnerie
                                    </a>
                            </li>
                             <li class="nav-item">
                                <a href="#on-elec" class="nav-link" data-toggle="tab" role="tab">Electricité
                        </a>
                            </li>

                              <li class="nav-item">
                                <a href="#on-elec" class="nav-link" data-toggle="tab" role="tab">Carrélage
                        </a>
                            </li>

                              <li class="nav-item">
                                <a href="#on-elec" class="nav-link" data-toggle="tab" role="tab">Peinture
                        </a>
                            </li>
                              <li class="nav-item">
                                <a href="#on-elec" class="nav-link" data-toggle="tab" role="tab">Divers
                        </a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="ts_product_wishlist">
                                                            <a href="wishlist.html" data-toggle="tooltip"
                                                                data-placement="top" title="favori"><i
                            ...
                            <div role="tabpanel" class="tab-pane fade show active" id="on-sale">
                             ...
                             <div role="tabpanel" class="tab-pane fade show active" id="on-elec">
                                <div class="on_sale_area">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
