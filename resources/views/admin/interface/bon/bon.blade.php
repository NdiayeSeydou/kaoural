                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.bon.index') }}">Bons de
                                        commande</a>
                                </li>
                        ...
                        <table class="table text-nowrap table-centered table-hover mb-0" data-check-container>
                            ...
                            <tbody>
                                @forelse ($bons as $bon)
                                    <tr>
                                        <td>
                                            <a href="{{ route('admin.bon.show', $bon->public_id) }}">
                                                #{{ $bon->public_id }}
                                            </a>
                                        </td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item d-flex align-items-center"
                                                        href="{{ route('admin.bon.show', $bon->public_id) }}">
                                                        <span class="me-2">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <!-- Modifier -->
                                                    <a class="dropdown-item d-flex align-items-center"
                                                        href="{{ route('admin.bon.edit', $bon->public_id) }}">
                                                        <span class="me-2">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
        ...
        function deleteBon(public_id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const url = "{{ route('admin.bon.destroy', ':id') }}".replace(':id', public_id);
