    ...
    <div class="custom-container">
        <div class="row justify-content-center">
            <div class="col-xl-9 col-md-12 col-12">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.vente.index') }}">Ventes</a></li>
                                <li class="breadcrumb-item active">Édition</li>
                            </ol>
                        </nav>
                    </div>
                    <div>
                        <a class="btn btn-dark" href="{{ route('admin.vente.index') }}"> Retour à la liste</a>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.vente.update', $vente->public_id) }}" method="POST">
                    @csrf
                    @method('PUT')
                ...
                <form id="delete-form" action="{{ route('admin.vente.destroy', $vente->public_id) }}" method="POST"
                    style="display:none;">
                    @csrf @method('DELETE')
                </form>
            </div>
