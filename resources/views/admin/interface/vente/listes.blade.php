...
@section('suite')
    ...
    <div class="custom-container">
        ...
        <div class="mb-4 d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.vente.create') }}" class="btn btn-dark">+ Ajouter une vente</a>
        </div>
        ...
        <div class="card mb-5 shadow-sm">
            <div class="card-body">
                <form action="{{ route('admin.vente.index') }}" method="GET">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-lg-5 col-md-12 d-flex gap-2">
                            ...
                            <a href="{{ route('admin.vente.index') }}" class="btn btn-outline-danger w-100">
                                Réinitialiser
                            </a>
                        </div>
                                            ...
                                            <tbody>
                                                @foreach ($itemsBoutique as $vente)
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            {{-- VOIR --}}
                                                            <a href="{{ route('admin.vente.show', ['public_id' => $vente->public_id]) }}"
                                                            ...
                                                            {{-- MODIFIER --}}
                                                            <a href="{{ route('admin.vente.edit', ['public_id' => $vente->public_id]) }}"
                                                                class="btn btn-ghost btn-icon btn-sm rounded-circle"
                                                                title="Modifier">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="18"
                                                                    height="18" viewBox="0 0 24 24" stroke-width="1.5"
                                                            ...
                                                            <form id="delete-form-{{ $vente->public_id }}"
                                                                action="{{ route('admin.vente.destroy', $vente->public_id) }}"
