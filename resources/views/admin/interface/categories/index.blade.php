                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('admin.categorie.index') }}">catégories</a>
                                </li>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item d-flex align-items-center"
                                                        href="{{ route('admin.categorie.show', $categorie->public_id) }}">
                                                        <span>
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <!-- Modifier -->
                                                    <a class="dropdown-item d-flex align-items-center"
                                                        href="{{ route('admin.categorie.edit', $categorie->public_id) }}">
                                                        <span>
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <form id="delete-form-{{ $categorie->public_id }}"
                                                        action="{{ route('admin.categorie.delete', $categorie->public_id) }}"
