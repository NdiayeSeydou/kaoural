        ...
        <div class="card border-0 shadow-sm mb-5 overflow-hidden">
            <div class="pt-12 rounded-top position-relative"
                ...
                <div class="position-absolute top-0 end-0 m-3">
                    <a href="{{ route('admin.creance.edit', $creance->public_id) }}"
            ...
            <div class="card-body">
                <div class="d-flex flex-column flex-md-row align-items-md-end mt-n5 gap-3">
                    ...
                    <div class="d-flex gap-2 pb-1">
                        <a href="{{ route('admin.creance.retrait', $creance->public_id) }}"
                                    ...
                                    <tbody>
                                        @foreach ($retraits as $retrait)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('admin.creance.editRetrait', $retrait->public_id) }}"
                                                    ...
                                                    <form id="delete-form-{{ $retrait->public_id }}"
                                                        action="{{ route('admin.creance.destroyRetrait', $retrait->public_id) }}"
