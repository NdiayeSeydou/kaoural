                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.creance.index') }}">Gestion des créances</a></li>
                                <li class="breadcrumb-item active">Ajouter un créancier</li>
                            </ol>
                        </nav>
                    </div>
                    <a href="{{ route('admin.creance.index') }}" class="btn btn-dark">
                        <i class="fe fe-arrow-left me-1"></i> Retour à la liste
                    </a>
                </div>

                {{-- Formulaire --}}
                <form action="{{ route('admin.creance.store') }}" method="POST">
                    @csrf
