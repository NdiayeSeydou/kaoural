...
@section('suite')
    ...
    <div class="custom-container">
        ...
        <div class="row mb-4">
            <div class="col-12 d-md-flex justify-content-between align-items-center">
                ...
                <div class="mt-3 mt-md-0">
                    <a href="{{ route('admin.creance.create') }}" class="btn btn-dark d-flex align-items-center gap-2">
        ...
        <div class="card mb-5 shadow-sm border-0">
            <div class="card-body">
                <form action="{{ route('admin.creance.index') }}" method="GET">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-lg-5 col-md-12 col-12 d-flex gap-2">
                            ...
                            <a href="{{ route('admin.creance.index') }}" class="btn btn-outline-danger w-100">
            ...
            <td>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        {{-- Détails --}}
                        <a class="dropdown-item" href="{{ route('admin.creance.show', $creance->public_id) }}">
                            Détails
                        </a>

                        {{-- Modifier --}}
                        <a class="dropdown-item" href="{{ route('admin.creance.edit', $creance->public_id) }}">
                            Modifier
                        </a>

                        {{-- Retrait --}}
                        <a class="dropdown-item" href="{{ route('admin.creance.retrait', $creance->public_id) }}">
                            Ajouter un retrait
                        </a>

                        {{-- Supprimer --}}
                        <form method="POST" action="{{ route('admin.creance.delete', $creance->public_id) }}"
