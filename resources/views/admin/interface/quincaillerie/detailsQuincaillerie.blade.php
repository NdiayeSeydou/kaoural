...
@section('title', 'Détails Quincaillerie | kaoural')
@section('suite')
                ...
                <div class="card card-lg overflow-hidden">
                    <div class="pt-16 rounded-top position-relative"
                        ...
                        <div class="position-absolute top-0 end-0 m-4">
                            <a href="{{ route('admin.quincaillerie.edit', $quincaillerie->public_id) }}"
                        ...
                        <div class="d-flex flex-column flex-lg-row gap-4">
                            ...
                            <div class="d-flex flex-column flex-lg-row justify-content-between w-100 gap-2">
                                <div class="d-lg-flex flex-lg-column">
                                    ...
                                    <div class="mt-4">
                                        <a href="{{ route('admin.quincaillerie.retrait', $quincaillerie->public_id) }}"
                                    ...
                                    <tbody>
                                        @foreach ($retraits as $retrait)
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('admin.quincaillerie.editRetrait', $retrait->public_id) }}"
                                                    ...
                                                    <form id="delete-form-{{ $retrait->public_id }}"
                                                        action="{{ route('admin.quincaillerie.destroyRetrait', $retrait->public_id) }}"
