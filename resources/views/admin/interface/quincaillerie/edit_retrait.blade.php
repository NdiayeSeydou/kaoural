...
<div class="row justify-content-center py-5">
    <div class="col-12">
        ...
        <!-- FORM -->
        <form action="{{ route('admin.quincaillerie.updateRetrait', $retrait->public_id) }}" method="POST">
            @csrf
...
<div class="col-md-6">
    ...
    @enderror
                ...
                <div class="col-12 d-flex justify-content-end gap-2 mt-3">
                    <a href="{{ route('admin.quincaillerie.show', $retrait->quincaillerie->public_id) }}" 
