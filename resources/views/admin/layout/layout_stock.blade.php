        ...
        <div class="main-container">
            ...
            <nav id="sidebar" class="sidebar-wrapper">
                ...
                <div class="app-brand p-3 my-2">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('kourekama/assets/images/logo.png') }}" class="logo" alt="Logo Kaoural" />
                    </a>
                </div>
                <!-- App brand ends -->
            ...
            <div class="app-container">
                ...
                <div class="app-header d-flex align-items-center">
                    ...
                    <div class="app-brand-sm d-lg-none d-flex">
                        ...
                        <!-- Logo sm starts -->
                        <a href="{{ route('dashboard') }}">
                            <img src="{{ asset('kourekama/assets/images/logo.png') }}" class="logo"
                                alt="Logo Kaoural" />
                        </a>
                        <!-- Logo sm end -->
                    ...
                    <div class="header-actions">
                        ...
                        {{-- <div class="header-actions-container rounded-4 d-flex align-items-center"> --}}
                            ...
                            <script>
                                ...
                                const actualAmount =
                                    "{{ number_format(app(\App\Http\Controllers\Admin\StocksController::class)->totalStockValue(), 0, ',', ' ') }} FCFA";
