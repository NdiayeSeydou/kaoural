...
@section('title', 'Consulter le stock et les details | Kaoural')
    ...
    <div class="container mt-4">
        ...
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0">Historique des entrées du produit  " {{ $stock->nom_produit }} " </h4>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach ($grouped as $day => $entriesByDay)
                                <tr>
                                    ...
                                    <td>{{ $entriesByDay->sum('quantite') }}</td>

                                    <td>
                                        <a href="{{ route('admin.stocks.entry.edit', [Crypt::encrypt($stock->id), $day]) }}"
                                            class="btn btn-sm btn-warning me-1">
                                            Modifier
                                        </a>

                                        <form
                                            action="{{ route('admin.stocks.entry.delete', [Crypt::encrypt($stock->id), $day]) }}"
                                            method="POST" class="d-inline delete-entry-form">
                                            @csrf
                                            @method('DELETE')
