                                ...
                                <div class="row gy-6 gx-sm-6">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="{{ route('password.request') }}" class="text-sm leading-6 fw-semibold text-decoration-none">Oublié?</a>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <p class="m-0 mt-4 text-body text-xs leading-6 text-center">
                                            ...
                                            <a href="{{ route('register') }}" class="text-decoration-none fw-semibold">Inscrivez-vous</a>.
                                        </p>
                                    </div>
            ...
            <div class="col-12 col-xl-6" data-bs-theme="dark">
                <div class="overflow-hidden position-relative position-xl-fixed top-0 bottom-0 start-0 end-50 d-flex align-items-center">
                    <div class="overflow-hidden position-absolute z-n1 top-0 end-0 bottom-0 start-0 m-sm-3 m-xl-4 border border-body-secondary rounded-top-5 rounded-sm-5 rounded-xl-6">
                        <!-- Background image -->
                        <img src="{{ asset('kaoural/img/logo kaoural.png') }}" class="position-absolute z-n1 top-0 h-100 w-100 object-fit-cover filter brightness-150 contrast-125 grayscale-100" alt="Sign In's testimonial">
                    ...
                    <div class="mx-auto max-w-4xl text-center px-6 px-sm-8 py-10">
                        ...
                        <figure class="m-0 mt-7">
                            <blockquote class="text-body-emphasis text-pretty text-2xl leading-9 fw-semibold">
                                ...
                                <p class="m-0">
                                    “Avec Quincaillerie Kaoural, la qualité et la confiance sont au rendez-vous. Chaque produit et chaque service sont pensés pour répondre aux besoins des clients avec efficacité, accessibilité et une expérience irréprochable.”
                                </p>
                            </blockquote>

                            <figcaption class="m-0 mt-7">
                                <!-- Client's Photoshoot -->
                                <img src="{{ asset('conn/assets/img/clients-photoshoot/small/member2.jpg') }}" class="rounded-circle border" width="40" height="40" alt="Client's photoshoot">
