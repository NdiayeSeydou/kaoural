...
@section('title','Mot de passe oublié | kaoural')
@section('suite')
                    ...
                    <div class="row h-100">
                        ...
                        <div class="col-12">
                            ...
                            <p class="m-0 pb-8 text-body-emphasis text-balance text-5xl leading-tight tracking-tight fw-semibold">
                                Changé votre mot de passe en toute sécurité!
                            </p>
                            ...
                            <div class="pb-xl-9">
                                <div class="row gy-6 gx-sm-6">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-lg btn btn-primary text-center w-100 rounded-pill">
            ...
            <div class="col-12 col-xl-6" data-bs-theme="dark">
                <div class="overflow-hidden position-relative position-xl-fixed top-0 bottom-0 start-0 end-50 d-flex align-items-center">
                    <div class="overflow-hidden position-absolute z-n1 top-0 end-0 bottom-0 start-0 m-sm-3 m-xl-4 border border-body-secondary rounded-top-5 rounded-sm-5 rounded-xl-6">
                        <!-- Background image -->
                        <img src="{{ asset('kaoural/img/logo kaoural.png') }}" class="position-absolute z-n1 top-0 h-100 w-100 object-fit-cover filter brightness-150 contrast-125 grayscale-100" alt="Reset Password's testimonial">
                    ...
                    <div class="mx-auto max-w-4xl text-center px-6 px-sm-8 py-10">
                        ...
                        <figure class="m-0 mt-7">
                            <blockquote class="text-body-emphasis text-pretty text-2xl leading-9 fw-semibold">
                                ...
                                <p class="m-0">
                                    “Mot de passe oublié ? Pas de panique ! Chez Quincaillerie Kaoural, la sécurité est entre vos mains. Réinitialisez en toute simplicité et reprenez le contrôle… parce qu’ici, la confiance ne s’efface jamais.”
                                </p>
                            </blockquote>
