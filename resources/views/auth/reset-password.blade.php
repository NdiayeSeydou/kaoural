...
@section('title', 'Vérification du code pin | Kaoural')
@section('suite')
                    ...
                    <div class="row h-100">
                        ...
                        <div class="col-12">
                            ...
                            <p
                                ...
                                Vérifiez votre email en entrant le code de vérification que nous venons de vous envoyer.
                            </p>
                    ...
                    <div class="mx-auto max-w-4xl text-center px-6 px-sm-8 py-10">
                        ...
                        <figure class="m-0 mt-7">
                            <blockquote class="text-body-emphasis text-pretty text-2xl leading-9 fw-semibold">
                                ...
                                <p class="m-0">
                                    “ Chez Kaoural, nous croyons que la confiance commence par la sécurité. C’est pourquoi, avant de pouvoir changer votre mot de passe, nous vous invitons à entrer le code PIN reçu par e‑mail. Cette étape simple garantit que vos informations restent protégées et que vous profitez pleinement de nos services. Ensemble, construisons avec assurance et sérénité. ”
                                </p>
                            </blockquote>
