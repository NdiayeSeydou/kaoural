    ...
    <div>
        <div id="miniSidebar">
            <div class="brand-logo">
                <a class='d-none d-md-flex align-items-center gap-2' href='{{ route('client.dashboard') }}'>
            ...
            <ul class="navbar-nav flex-column  ">
                <!-- Nav item -->
                <li class="nav-item">
                    <a class='nav-link' href='{{ route('client.dashboard') }}'><span class="nav-icon"><svg
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('client.historiques') }}">Historique</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('produit') }}">passer une commande</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <span class="nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <text x="9" y="19" font-size="6" fill="currentColor">€</text>
                                </svg>
                            </span>

                            <span class="text">Mes créances</span>
                        </div>
                    ...
                    <ul class="dropdown-menu flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('client.creances') }}">Listes</a>
                        </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('client.devis') }}">Listes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('client.devis.create') }}">Demande de dévis</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('client.factures') }}">Listes</a>
                        </li>
                ...
                <li class="nav-item">
                    <a class='nav-link' href='{{ route('client.profils') }}'><span class="nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="offcanvasNav offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
            ...
            <div class="offcanvas-body p-0">
                ...
                <ul class="navbar-nav flex-column  ">
                    <!-- Nav item -->
                    <li class="nav-item">
                        <a class='nav-link' href='{{ route('admin.dashboard') }}'><span class="nav-icon"><svg
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.vente.index') }}">Listes</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.vente.create') }}">Ajouter</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.stock.index') }}">Listes</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.stock.create') }}">Ajouter</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.fournisseur.index') }}">Listes</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.fournisseur.create') }}">Ajouter</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.facture.index') }}">Listes</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.facture.create') }}">Créer</a>
                            </li>
                        </ul>
                    </li>
                    <!-- Nav item -->
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.bon.index') }}">Listes</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.bon.create') }}">Créer</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.quincaillerie.index') }}">Listes</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.quincaillerie.create') }}">Ajouter</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.creance.index') }}">Listes</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.creance.create') }}">Ajouter</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.order.index') }}">Listes</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.order.status') }}">Status</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.demande.index') }}">Listes</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <!-- Nav item -->
                    <li class="nav-item">
                        <a class='nav-link' href='{{ route('admin.blog.index') }}'><span class="nav-icon"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li class="nav-item">
                        <a class='nav-link' href='{{ route('admin.produit.index') }}'><span class="nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <!-- Nav item -->
                    <li class="nav-item">
                        <a class='nav-link' href='{{ route('admin.categorie.index') }}'><span class="nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li class="nav-item">
                        <a class='nav-link' href='{{ route('admin.monprofil') }}'><span class="nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="icon icon-tabler icon-tabler-settings">
