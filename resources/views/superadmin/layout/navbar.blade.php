  ...
  <ul class="navbar-nav flex-column  ">
    ...
    <li class="nav-item">
      <a class='nav-link' href='dashboard/analytics.html'>
        <span class="nav-icon "><svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-chart-histogram"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 3v18h18" /><path d="M20 18v3" /><path d="M16 16v5" /><path d="M12 13v8" /><path d="M8 16v5" /><path d="M3 11c6 0 5 -5 9 -5s3 5 9 5" /></svg></span> <span class="text">Analytics</span></a
      >
    </li>
    <!-- Nav item -->
    <li class="nav-item">
      <a class='nav-link' href='dashboard/ecommerce.html'><span class="nav-icon"><svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-shopping-bag"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M6.331 8h11.339a2 2 0 0 1 1.977 2.304l-1.255 8.152a3 3 0 0 1 -2.966 2.544h-6.852a3 3 0 0 1 -2.965 -2.544l-1.255 -8.152a2 2 0 0 1 1.977 -2.304z" /><path d="M9 11v-5a3 3 0 0 1 6 0v5" /></svg></span> <span class="text">Ecommerce</span></a
      >
    </li>
    <!-- Nav item -->
    <li class="nav-item">
      <a class='nav-link' href='dashboard/crm.html'><span class="nav-icon"><svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-phone"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 4h4l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5 -2.5l5 2v4a2 2 0 0 1 -2 2a16 16 0 0 1 -15 -15a2 2 0 0 1 2 -2" /></svg></span> <span class="text">CRM</span></a
      >
    </li>
    <!-- Nav item -->
    <li class="nav-item">
      <a class='nav-link' href='dashboard/finance.html'><span class="nav-icon"><svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-brand-mastercard"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 12m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" /><path d="M12 9.765a3 3 0 1 0 0 4.47" /><path d="M3 5m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z" /></svg></span> <span class="text">Finance</span></a
      >
    </li>
    <!-- Nav item -->
    <li class="nav-item">
      <a class='nav-link' href='dashboard/blog.html'><span class="nav-icon"><svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-news"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" /><path d="M8 8l4 0" /><path d="M8 12l4 0" /><path d="M8 16l4 0" /></svg></span> <span class="text">Blog</span></a
      >
    </li>
    <!-- Nav item -->
    <li class="nav-item">
      <a class='nav-link' href='dashboard/file.html'><span class="nav-icon"><svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-file-text"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /><path d="M9 9l1 0" /><path d="M9 13l6 0" /><path d="M9 17l6 0" /></svg></span> <span class="text">File</span></a
      >
    </li>
    ...
    <li class="nav-item">
      <a class='nav-link' href='apps/calendar.html'>
        <span class="nav-icon">
          <svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-calendar"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12z" /><path d="M16 3v4" /><path d="M8 3v4" /><path d="M4 11h16" /><path d="M11 15h1" /><path d="M12 15v3" /></svg>
        </span>
    ...
    <li class="nav-item">
      <a class='nav-link' href='apps/chat-app.html'>
        <span class="nav-icon">
          <svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-message-dots"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 11v.01" /><path d="M8 11v.01" /><path d="M16 11v.01" /><path d="M18 4a3 3 0 0 1 3 3v8a3 3 0 0 1 -3 3h-5l-5 3v-3h-2a3 3 0 0 1 -3 -3v-8a3 3 0 0 1 3 -3z" /></svg>
        </span>
    ...
    <li class="nav-item">
      <a class='nav-link' href='apps/kanban.html'>
        <span class="nav-icon">
          <svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-brand-trello"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z" /><path d="M7 7h3v10h-3z" /><path d="M14 7h3v6h-3z" /></svg>
        </span>
    ...
    <li class="nav-item dropdown">
      ...
      <ul class="dropdown-menu flex-column">
        <li class="nav-item">
          <a class='nav-link' href='apps/email/mail'>Inbox</a>
        </li>
        <li class="nav-item">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        <span class="nav-icon">
          <svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-shopping-bag-edit"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M11 21h-2.426a3 3 0 0 1 -2.965 -2.544l-1.255 -8.152a2 2 0 0 1 1.977 -2.304h11.339a2 2 0 0 1 1.977 2.304l-.109 .707" /><path d="M9 11v-5a3 3 0 0 1 6 0v5" /><path d="M18.42 15.61a2.1 2.1 0 0 1 2.97 2.97l-3.39 3.42h-3v-3l3.42 -3.39z" /></svg>
        </span>
        <span class="text">Ecommerce</span>
      </a>
      <ul class="dropdown-menu flex-column">
        <li class="nav-item">
          <a class='nav-link' href='apps/e-commerce/ecommerce-products'>Products</a>
        </li>
        <li class="nav-item">
          <a class='nav-link' href='apps/e-commerce/ecommerce-products-details'>Product Detail</a>
        </li>
        <li class="nav-item">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        <span class="nav-icon">
          <svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-chart-pie-2"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3v9h9" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
        </span>
   ...
   <!-- Nav item -->
    ...
    <li class="nav-item">
      <a class='nav-link' href='docs/changelog.html'>
        <span class="nav-icon">
          <svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-git-merge"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 18m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M7 6m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M17 12m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M7 8l0 8" /><path d="M7 8a4 4 0 0 0 4 4h4" /></svg>
        </span>
    ...
    <li class="nav-item">
      <a class="nav-link disabled text-gray-400" href="#!" aria-disabled="true" style="cursor:not-allowed">
        <span class="nav-icon">
          <svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-circle-off"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M20.042 16.045a9 9 0 0 0 -12.087 -12.087m-2.318 1.677a9 9 0 1 0 12.725 12.73" /><path d="M3 3l18 18" /></svg>
        </span>
    ...
    <!-- Nav item -->
    <li class="nav-item">
      <a aria-label='External Link' class='nav-link position-relative ' href='pages/blank.html' target='_blank'>
        <span class="nav-icon">
          <svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-file"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /></svg>
        </span>
          ...
          <div class="d-flex flex-column border-bottom border-dashed py-4">
            ...
            <div>
              <ul class="list-unstyled lh-lg mb-0">
                ...
                <li><a class='text-inherit' href='apps/e-commerce/ecommerce-products'>Ecommerce</a></li>
            ...
            <div class="card card-lg bg-gradient-success">
              ...
              <div class="card-body d-flex flex-column gap-8">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <div class="fw-semibold">Total Projects</div>
                  </div>
              ...
              <div class="card-body d-flex flex-column gap-8">
                ...
                <div class="lh-1 d-flex flex-column gap-3">
                  ...
                  <p class="mb-0">
                    ...
                    <span class="text-secondary">Increased</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="row g-6 mb-6">
          <div class="col-xl-8 col-12">
            ...
            <div class="card card-lg mb-6">
                ...
                <table class="table text-nowrap mb-0 table-centered table-hover">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div>
                          ...
                          <div class="small text-secondary">Jan 30, 2025</div>
                        </div>
                      </td>
                      <td>
                        <div class="me-3">65%</div>
                        <div class="w-50">
                      ...
                      <td>
                        <span class="badge text-info-emphasis bg-info-subtle rounded-2"> On Track</span>
                      </td>
                      <td>
                        <div class="avatar-group">
                          ...
                          <span class="avatar avatar-sm avatar-info">
                            <span class="avatar-initials rounded-circle">+5</span>
                          </span>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div>
                          ...
                          <div class="small text-secondary">Deadline: Feb 10, 2025</div>
                        </div>
                      </td>
                      <td>
                        <div class="me-3">20%</div>
                        <div class="w-50">
                          <div class="progress" style="height: 5px">
                      ...
                      <td>
                        <span class="badge text-danger-emphasis bg-danger-subtle rounded-2"> Delayed</span>
                      </td>
                      <td>
                        <div class="avatar-group">
                          <span class="avatar avatar-sm">
                            <img alt="avatar bootstrap 5" src="assets/images/avatar/avatar-1.jpg"
                              class="rounded-circle" />
                          </span>
                          <span class="avatar avatar-sm">
                            <img alt="bootstrap 5 avatar" src="assets/images/avatar/avatar-3.jpg"
                              class="rounded-circle" />
                          </span>
                          <span class="avatar avatar-sm">
                            <img alt="bootstrap 5 avatar in circle" src="assets/images/avatar/avatar-4.jpg"
                              class="rounded-circle" />
                          </span>
                    ...
                    <tr>
                      <td>
                        <div>
                          ...
                          <div class="small text-secondary">Deadline: Mar 1, 2025</div>
                        </div>
                      </td>
                      <td>
                        <div class="me-3">45%</div>
                        <div class="w-50">
                          <div class="progress" style="height: 5px">
                      ...
                      <td>
                        <span class="badge text-warning-emphasis bg-warning-subtle rounded-2"> At Risk</span>
                      </td>
                      <td>
                        <div class="avatar-group">
                          <span class="avatar avatar-sm">
                          ...
                          <span class="avatar avatar-sm avatar-warning">
                            <span class="avatar-initials rounded-circle">+1</span>
                          </span>
                          <span class="avatar avatar-sm">
                            <img alt="bootstrap 5 avatar" src="assets/images/avatar/avatar-5.jpg"
                              class="rounded-circle" />
                          </span>
                          <span class="avatar avatar-sm">
                            <img alt="bootstrap 5 avatar in circle" src="assets/images/avatar/avatar-6.jpg"
                              class="rounded-circle" />
                          </span>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div>
                          <div>Customer Portal Upgrade</div>
                          <div class="small text-secondary">Deadline: Feb 15, 2025</div>
                        </div>
                      </td>
                      <td>
                        <div class="me-3">89%</div>
                        <div class="w-50">
                          <div class="progress" style="height: 5px">
                            <div class="progress-bar bg-info" role="progressbar" style="width: 89%" aria-valuenow="89"
                              aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div>
                          ...
                          <div class="small text-secondary">Deadline: Jan 25, 2025</div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <span class="badge text-primary-emphasis bg-primary-subtle rounded-2"> Completed</span>
                      </td>
                      <td>
                        <div class="avatar-group">
                          <span class="avatar avatar-sm">
                          ...
                          <span class="avatar avatar-sm">
                            <img alt="bootstrap 5 avatar" src="assets/images/avatar/avatar-8.jpg"
                              class="rounded-circle" />
                          </span>
                          <span class="avatar avatar-sm">
                            <img alt="bootstrap 5 avatar in circle" src="assets/images/avatar/avatar-9.jpg"
                              class="rounded-circle" />
                          </span>
                        </div>
                      </td>
              ...
              <!-- card footer -->
              <div class="card-footer border-dashed border-top text-center">
                <a href="#!" class="btn btn-link">View All Projects</a>
              </div>
            </div>
            <!-- row -->
            <div class="row row-cols-xxl-2 row-cols-1">
              <div class="col">
                <!-- card -->
                <div class="card card-lg mb-6">
                  <!-- card body -->
                  <div class="card-body">
                    ...
                    <div class="d-flex flex-column">
                      <div class="border-bottom border-dashed d-flex justify-content-between align-items-end py-3">
                        <div class="d-flex align-items-center gap-3">
                          <img src="assets/images/avatar/avatar-1.jpg" class="avatar avatar-md rounded-circle"
                            alt="avatar" />
                          <div>
                            <div class="fw-semibold">John Doe</div>
                            <div class="text-secondary">Project Manager</div>
                          </div>
                        </div>
                        <div class="text-secondary">Tasks: 2 Assigned</div>
                      </div>
                      <div class="border-bottom border-dashed d-flex justify-content-between align-items-end py-3">
                        <div class="d-flex align-items-center gap-3">
                          <img src="assets/images/avatar/avatar-14.jpg" class="avatar avatar-md rounded-circle"
                            alt="avatar" />
                          <div>
                      ...
                      <div class="border-bottom border-dashed d-flex justify-content-between align-items-end py-3">
                        <div class="d-flex align-items-center gap-3">
                          <img src="assets/images/avatar/avatar-9.jpg" class="avatar avatar-md rounded-circle"
                            alt="avatar" />
                          <div>
                            <div class="fw-semibold">Emily Johnson</div>
                            <div class="text-secondary">Designer</div>
                          </div>
                        </div>
                        <div class="text-secondary">Tasks: 3 Assigned</div>
                      </div>
                      <div class="border-bottom border-dashed d-flex justify-content-between align-items-end py-3">
                        <div class="d-flex align-items-center gap-3">
                          <img src="assets/images/avatar/avatar-6.jpg" class="avatar avatar-md rounded-circle"
                            alt="avatar" />
                          <div>
                            <div class="fw-semibold">Jitu Chauhan</div>
                            <div class="text-secondary">Designer</div>
                          </div>
                        </div>
                        <div class="text-secondary">Tasks: 8 Assigned</div>
                      </div>
                      <div class="border-bottom border-dashed d-flex justify-content-between align-items-end py-3">
                        <div class="d-flex align-items-center gap-3">
                          <img src="assets/images/avatar/avatar-5.jpg" class="avatar avatar-md rounded-circle"
                            alt="avatar" />
                          <div>
                            <div class="fw-semibold">Anita Parmar</div>
                            <div class="text-secondary">Front End Developer</div>
                          </div>
                        </div>
                        <div class="text-secondary">Tasks: 7 Assigned</div>
                      </div>
                      <div class="d-flex justify-content-between align-items-end py-3">
                        <div class="d-flex align-items-center gap-3">
                          <img src="assets/images/avatar/avatar-11.jpg" class="avatar avatar-md rounded-circle"
                            alt="avatar" />
                          <div>
                            <div class="fw-semibold">Manasvi Suthar</div>
                            <div class="text-secondary">UI Developer</div>
                          </div>
                        </div>
                        <div class="text-secondary">Tasks: 3 Assigned</div>
                      </div>
                      <div class="mt-4">
                        <a href="#!" class="btn btn-white">View All Members</a>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="timeline-vertical timeline-vertical-height">
                        <div class="timeline-item position-relative">
                          <div class="row g-0">
                            ...
                            <div class="col-11">
                              <div>Design phase completed by Alice.</div>
                      ...
                      <div class="timeline-vertical timeline-vertical-height">
                        <div class="timeline-item position-relative">
                          <div class="row g-0">
                            ...
                            <div class="col-11">
                              <div>Initial client presentation delivered by Bob.</div>
                      ...
                      <div class="timeline-vertical timeline-vertical-height">
                        <div class="timeline-item position-relative">
                          <div class="row g-0">
                            ...
                            <div class="col-11">
                              <div>Resource allocation updated by Charlie.</div>
                      ...
                      <div class="timeline-vertical timeline-vertical-height">
                        <div class="timeline-item position-relative">
                          <div class="row g-0">
                            ...
                            <div class="col-11">
                              <div>Risk assessment review completed by Dana.</div>
                      ...
                      <div class="timeline-vertical timeline-vertical-height">
                        <div class="timeline-item position-relative">
                          <div class="row g-0">
                            ...
                            <div class="col-11">
                              <div>New milestone added by Eve.</div>
            ...
            <div class="card card-lg">
              ...
              <div class="card-body">
                ...
                <div style="height: 320px" data-simplebar>
                  <div class="d-flex justify-content-between align-items-center border-bottom border-dashed py-3 px-2">
                    <div class="d-flex align-items-center gap-3">
                      <div class="form-check mb-0">
                        <input class="form-check-input" type="checkbox" value="" id="taskCheck1" />
                        <label class="form-check-label" for="taskCheck1">Design project logo</label>
                      </div>
                      <div>
                        <span class="badge text-info-emphasis bg-info-subtle"> High</span>
                      </div>
                    </div>
                    <div>
                      <div class="dropdown dropstart">
                  ...
                  <div class="d-flex justify-content-between align-items-center border-bottom border-dashed py-3 px-2">
                    <div class="d-flex align-items-center gap-3">
                      <div class="form-check mb-0">
                        <input class="form-check-input" type="checkbox" value="" id="taskCheck2" />
                        <label class="form-check-label" for="taskCheck2">Create project plan</label>
                      </div>
                      <div>
                        <span class="badge text-warning-emphasis bg-warning-subtle"> Medium</span>
                      </div>
                    </div>
                    <div>
                      <div class="dropdown dropstart">
                  ...
                  <div class="d-flex justify-content-between align-items-center border-bottom border-dashed py-3 px-2">
                    <div class="d-flex align-items-center gap-3">
                      <div class="form-check mb-0">
                        <input class="form-check-input" type="checkbox" value="" id="taskCheck3" />
                        <label class="form-check-label" for="taskCheck3">Update team assignments</label>
                      </div>
                      <div>
                        <span class="badge text-primary-emphasis bg-primary-subtle"> Low</span>
                      </div>
                    </div>
                    <div>
                      <div class="dropdown dropstart">
                  ...
                  <div class="d-flex justify-content-between align-items-center border-bottom border-dashed py-3 px-2">
                    <div class="d-flex align-items-center gap-3">
                      <div class="form-check mb-0">
                        <input class="form-check-input" type="checkbox" value="" id="taskCheck4" />
                        <label class="form-check-label" for="taskCheck4">Prepare project budget</label>
                      </div>
                      <div>
                        <span class="badge text-danger-emphasis bg-danger-subtle"> Critical</span>
                      </div>
                    </div>
                    <div>
                      <div class="dropdown dropstart">
                  ...
                  <div class="d-flex justify-content-between align-items-center border-bottom border-dashed py-3 px-2">
                    <div class="d-flex align-items-center gap-3">
                      <div class="form-check mb-0">
                        <input class="form-check-input" type="checkbox" value="" id="taskCheck5" />
                        <label class="form-check-label" for="taskCheck5">Dasher UI Figma Design</label>
                      </div>
                      <div>
                        <span class="badge text-primary-emphasis bg-primary-subtle"> Low</span>
                      </div>
                  ...
                  <div class="d-flex justify-content-between align-items-center pt-3 px-2">
                    <div class="d-flex align-items-center gap-3">
                      <div class="form-check mb-0">
                        <input class="form-check-input" type="checkbox" value="" id="taskCheck6" />
                        <label class="form-check-label" for="taskCheck6">Dasher UI Bootstrap Development</label>
                      </div>
                      <div>
                        <span class="badge text-primary-emphasis bg-primary-subtle"> Low</span>
                      </div>
          ...
          <div class="col-xl-4 col-lg-12 col-12">
            ...
            <div class="card card-lg mb-6">
              ...
              <div class="card-body">
                ...
                <div class="fs-1 fw-bold mb-3">64%</div>
                <div class="d-flex align-items-center gap-1 w-100 mb-4">
                  <div class="w-25" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Completed">
                    <div class="progress mb-2" style="height: 3px">
                      <div class="progress-bar bg-info-light" role="progressbar" style="width: 100%" aria-valuenow="100"
                        aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    24%
                  </div>
                  <div class="w-50" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="In Progress">
                    <div class="progress mb-2" style="height: 3px">
                      <div class="progress-bar bg-success-light" role="progressbar" style="width: 100%"
                        aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    35%
                  </div>
                  <div class="w-75" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Up Coming">
                    <div class="progress mb-2" style="height: 3px">
                      <div class="progress-bar bg-danger-light" role="progressbar" style="width: 100%"
                        aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    41%
                  </div>
                  ...
                  <div class="row g-3">
                    <div class="col-md-4 col-12">
                      ...
                      <div class="card card-lg">
                        ...
                        <div class="card-body text-center p-3">
                          <div class="icon-shape icon-lg bg-info-subtle text-info-emphasis rounded-pill">
                          ...
                          <div class="lh-1 mt-4">
                            <div class="fs-4 fw-bold mb-1">8</div>
                    ...
                    <div class="col-md-4 col-12">
                      ...
                      <div class="card card-lg">
                        <!-- card body -->
                        <div class="card-body text-center p-3">
                          <div class="icon-shape icon-lg bg-success-subtle text-success-emphasis rounded-pill">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                              fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                          ...
                          <div class="lh-1 mt-4">
                            <div class="fs-4 fw-bold mb-1">12</div>
                    ...
                    <div class="col-md-4 col-12">
                      ...
                      <div class="card card-lg">
                        <!-- card body -->
                        <div class="card-body text-center p-3">
                          <div class="icon-shape icon-lg bg-danger-subtle text-danger-emphasis rounded-pill">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                              fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                              stroke-linejoin="round"
                          ...
                          <div class="lh-1 mt-4">
                            <div class="fs-4 fw-bold mb-1">14</div>
                            <div class="text-secondary small">Up Coming</div>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <!-- card -->
            <div class="card card-lg mb-6" style="background: linear-gradient(97.05deg, #008fba 0%, #00a76f 100%)"
              data-bs-theme="dark">
              <!-- card body -->
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between">
                  <div>
                    <div class="fs-3 fw-bold text-white mb-3">
                  ...
                  <div>
                    <img src="assets/images/png/dasher-ai.png" alt="" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card card-lg mb-6">
              ...
              <div class="card-body">
                <div class="mb-4">
                  <h5 class="mb-1">Project Budget</h5>
                  <span class="text-secondary">Budget Allocation Overview:</span>
                </div>
                <div class="fs-2 fw-bold mb-3">$50,000</div>
                <div class="d-flex justify-content-between align-items-center gap-1 w-100 mb-2">
                  <div>Spent:</div>
                  <div>$35,000</div>
                </div>
                <div class="d-flex justify-content-between align-items-center gap-1 w-100 mb-4">
                  <div>Remaining:</div>
                  <div>$15,000</div>
                </div>
                <div class="d-flex justify-content-between gap-3">
                  <a href="#!" class="btn btn-primary w-100">Add Budget</a>
                  <a href="#!" class="btn btn-white w-100">View Details</a>
                </div>
              </div>
            </div>
            <!-- card -->
            <div class="card card-lg mb-6">
              ...
              <div class="card-body">
                <div class="mb-4 position-relative py-2">
                  ...
                  <div class="swiper-navigation position-absolute top-50 end-10 me-4">
                                  ...
                                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    ...
                                    <g clip-path="">
                                      ...
                                      <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M4.69456 10.2865H9.98557V6.40671C9.98557 5.82219 9.51189 5.34851 8.92737 5.34851H3.63635V9.22828C3.63635 9.8128 4.11003 10.2865 4.69456 10.2865ZM10.6907 8.87586L12.8071 10.2865V5.34851L10.691 6.75945L10.6907 8.87586Z"
                                        fill="white" />
                                    </g>
                                    <defs>
                                      <clipPath>
