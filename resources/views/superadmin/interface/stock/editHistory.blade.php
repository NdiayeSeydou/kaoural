        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-md-12 col-12">
                ...
                <div class="mb-8 d-md-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a class="btn btn-dark" href="{{ route('superadmin.stock.show', $history->stock->public_id) }}">
                            Retour
                        </a>
                    </div>
                </div>

                <form action="{{ route('superadmin.stock.history.update', $history->public_id) }}" method="POST">
                    @csrf
                    @method('PUT')
