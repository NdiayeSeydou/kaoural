        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 col-12 mx-auto">
                ...
                <nav aria-label="breadcrumb" class="mb-4">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('superadmin.creance.index') }}">Créances</a></li>
                ...
                <div class="card border-0 shadow-sm overflow-hidden">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('superadmin.creance.updateRetrait', $retrait->public_id) }}" method="POST">
                            @csrf
                            @method('PUT')
