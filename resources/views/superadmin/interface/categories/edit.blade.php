...
<div class="custom-container">
    <div class="row justify-content-center">
        <div class="col-xl-6 col-md-12 col-12">
                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('superadmin.categorie.index') }}">Catégories</a></li>
                            <li class="breadcrumb-item active">Édition</li>
                        </ol>
                    </nav>
                </div>
                <div>
                    <a class="btn btn-dark" href="{{ route('superadmin.categorie.index') }}">
                        Retour à la liste
                    </a>
                </div>
            </div>
            ...
            <form action="{{ route('superadmin.categorie.update', $categorie->public_id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('superadmin.categorie.index') }}" class="btn btn-outline-secondary">
                        Annuler
                    </a>
