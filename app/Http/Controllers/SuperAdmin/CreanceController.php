...
class CreanceController extends Controller
{
    ...
    public function creances()
    {
        ...
        return view('superadmin.interface.creance.listes', compact('creances', 'totalCreances'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superadmin.creance.index')->with('creanceajout', 'Créancier ajoutée avec succès');
    }
    ...
    public function editCreance($public_id)
    {
        ...
        return view('superadmin.interface.creance.edit', compact('creance'));
    }
    ...
    public function update(Request $request, $public_id)
    {
        ...
        return redirect()->route('superadmin.creance.index')->with('creancemodif', 'Créance mise à jour');
    }
    ...
    public function addretrait($public_id)
    {
        ...
        return view('superadmin.interface.creance.retrait',   compact('creance', 'stocks')
        );
    }
    ...
    public function ajoutstore(Request $request, $public_id)
    {
        ...
        return redirect()->route('superadmin.creance.show', $creance->public_id)->with('retraitadd', 'Le retrait sur créance a été effectué et le stock mis à jour.');
    }
    ...
    public function editRetrait($public_id)
    {
        ...
        return view('superadmin.interface.creance.edit_retrait', compact('retrait'));
    }
    ...
    public function updateRetrait(Request $request, $public_id)
    {
        ...
        return redirect()->route('superadmin.creance.show', $creance_public_id)->with('modifprod', 'Retrait mis à jour avec succès');
    }
    ...
    public function destroyRetrait($public_id)
    {
        ...
        return redirect()->route('superadmin.creance.show', $creance->public_id)->with('deleteretrait', 'Retrait supprimé avec succès.');
    }
}
