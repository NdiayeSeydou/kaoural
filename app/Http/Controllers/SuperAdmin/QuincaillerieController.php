...
class QuincaillerieController extends Controller
{
    ...
    public function quincaillerie()
    {
        ...
        return view('superadmin.interface.quincaillerie.listes', compact('quincailleries'));
    }
    ...
    public function detailsQuincaillerie($public_id)
    {
        ...
        return view('superadmin.interface.quincaillerie.detailsQuincaillerie', compact('quincaillerie', 'retraitsParJour'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superadmin.quincaillerie.index')->with('quinajout', 'Quincaillerie ajoutée avec succès');
    }
    ...
    public function editQuincaillerie($public_id)
    {
        ...
        return view('superadmin.interface.quincaillerie.editQuincaillerie', compact('quincaillerie'));
    }
    ...
    public function update(Request $request, $public_id)
    {
        ...
        return redirect()->route('superadmin.quincaillerie.index')->with('quinmodif', 'Quincaillerie mise à jour');
    }
    ...
    public function addretrait($public_id)
    {
        ...
        return view(
            'superadmin.interface.quincaillerie.retrait',
    ...
    public function ajoutstore(Request $request, $public_id)
    {
        ...
        return redirect()->route('superadmin.quincaillerie.show', $quincaillerie->public_id)->with('retraitadd', 'Retrait ajouté avec succès');
    }
    ...
    public function editRetrait($public_id)
    {
        ...
        return view('superadmin.interface.quincaillerie.edit_retrait', compact('retrait'));
    }
    ...
    public function updateRetrait(Request $request, $public_id)
    {
        ...
        return redirect()->route('superadmin.quincaillerie.show', $quincaillerie->public_id)->with('modifprod', 'Retrait mis à jour avec succès');
    }
    ...
    public function destroyRetrait($public_id)
    {
        ...
        return redirect()->route('superadmin.quincaillerie.show', $retrait->quincaillerie->public_id)->with('deleteretrait', 'Retrait supprimé avec succès.');
    }
