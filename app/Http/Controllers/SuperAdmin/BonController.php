...
class BonController extends Controller
{
    ...
    public function bon()
    {
        ...
        return view('superadmin.interface.bon.bon', compact('bons'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superadmin.bon.index')->with('bonajo', 'Bon créé avec succès');
    }
    ...
    public function detailsBon($public_id)
    {
        ...
        return view('superadmin.interface.bon.show', compact('bon'));
    }
    ...
    public function editBon($public_id)
    {
        ...
        return view('superadmin.interface.bon.edit', compact('bon'));
    }
    ...
    public function update(Request $request, $public_id)
    {
        ...
        return redirect()->route('superadmin.bon.index', $bon->public_id)->with('bonmodif', 'Bon modifié avec succès');
    }
    ...
    public function destroy($public_id)
    {
        ...
        return redirect()->route('superadmin.bon.index')->with('bondel', 'Bon supprimé');
    }
    ...
    //     $pdf = Pdf::loadView('superadmin.interface.bon.pdf', compact('bon'));
