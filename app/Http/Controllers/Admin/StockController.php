...
class StockController extends Controller
{
    ...
    public function stock()
    {
        ...
        return view('admin.interface.stock.listes', compact('stocksBoutique', 'categories', 'fournisseurs', 'stocksMagasin'));
    }
    ...
    public function storeNouveauProduit(Request $request)
    {
        ...
        return redirect()->route('admin.stock.index')->with('stockajoutnew', 'Nouveau produit ajouté avec succès');
    }
    ...
    public function storeProduitExistant(Request $request)
    {
      ...
      $quantite = floatval(str_replace(',', '.', $request->quantite));
        ...
        return redirect()->route('admin.stock.index')->with('ajoutstockaancien', 'Stock mis à jour avec succès');
    }
    ...
    public function detailsStock($public_id)
    {
        ...
        return view('admin.interface.stock.detailsStock', compact('stock', 'histories'));
    }
    ...
    public function addStock()
    {
        ...
        $fournisseurs = Fournisseur::all();
        return view('admin.interface.stock.create', compact('categories', 'fournisseurs'));
    }
    ...
    public function editStock($public_id)
    {
        ...
        return view('admin.interface.stock.edit', compact('stock', 'categories', 'fournisseurs'));
    }
    ...
    public function updateStock(Request $request, $public_id)
    {
        ...
        return redirect()->route('admin.stock.index')->with('stockupdt', 'Stock mis à jour avec succès');
    }
    ...
    public function destroyStock($public_id)
    {
        ...
        return redirect()->route('admin.stock.index')->with('stockdel', 'Stock supprimé avec succès');
    }
    ...
    public function editHistory($public_id)
    {
        ...
        return view('admin.interface.stock.editHistory', compact('history', 'fournisseurs'));
    }
    ...
    public function updateHistory(Request $request, $historyPublicId)
    {
        ...
        return redirect()->route('admin.stock.show', $stock->public_id)->with('edithistory', 'Historique mis à jour avec succès');
    }
    ...
    public function destroyHistory($historyPublicId)
    {
        ...
        if ($stock) {
            return redirect()->route('admin.stock.show', $stock->public_id)->with('historydel', $message);
        }

        return redirect()->route('admin.stock.index')->with('historydel', $message);
    }
}
